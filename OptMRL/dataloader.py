#code is written by Ziga Avsec, distributed under MIT license
#obtained from https://github.com/kipoi/models/blob/master/Optimus_5Prime/dataloader.py and adopted without change
